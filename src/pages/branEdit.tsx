      ...
      <div className="max-w-md w-full mx-auto py-6 px-8 bg-white rounded-2xl border border-[#e7e3e4]">
        ...
        <div className="w-full flex flex-col gap-4 mt-8">
          ...
          <div className="flex justify-between gap-2 mt-8">
            <button
              className="flex items-center justify-center gap-2 px-4 rounded-lg font-medium text-sm
              bg-[#f5f4f4] text-[#b91c1c] cursor-pointer h-9"
            >
            ...
            >
              <Icon icon="lucide-lab:save" width="18" />
              <p>Хадгалах</p>
            </button>
          </div>
        </div>
